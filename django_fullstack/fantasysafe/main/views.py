...
def gameplay(request):
    player1 = Player.objects.get(id=request.POST['player1_id'])
    ...
    player2 = Player.objects.get(id=request.POST['player2_id'])
    ...
    player3 = Player.objects.get(id=request.POST['player3_id'])
