...
class Roster(models.Model):
    ...
    # use User instead of models.Model
class Computer(models.Model):
    name = models.CharField(max_length=255)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    
class Computer_roster(models.Model):
    computer = models.OneToOneField(Computer, related_name="cpu_roster", on_delete = models.CASCADE)  
    players = models.ManyToManyField(Player, related_name="cpu_rosters")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
